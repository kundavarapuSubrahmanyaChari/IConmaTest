package com.conma.vegitable.report;
...
import com.conma.vegitable.R;
import com.conma.vegitable.database.Student;
...
public class CustomAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
			...
			row = inflater.inflate(R.layout.displayinflater, parent, false);
		}
