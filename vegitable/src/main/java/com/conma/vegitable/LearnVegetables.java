...
import com.conma.vegitable.database.TestAdapter;
...
public class LearnVegetables extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int i = Integer.parseInt(savePlayerNameDB(userName));
		savePlayerNameApplication(userName, i);
	...
	private void loadSound() {
		...
		greenpepper = sp.load(this, R.raw.greenpepper, 1);
		...
		redpepper = sp.load(this, R.raw.redpepper, 1);
